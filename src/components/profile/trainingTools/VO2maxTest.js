...
export const VO2maxTest = () => {
    ...
    return (<>
        <article className="VO2-container">
            ...
            {!faq ?
                <div className="standards" onClick={() => { toggleFaq(true) }}>
                    FAQ 🔽
                </div>
                :
                <div className="standards" onClick={() => { toggleFaq(false) }}>
                    FAQ 🔼
                </div>
            }
            ...
            {!standards ?
                <div className="standards" onClick={() => { toggleStandards(true) }}>
                    Standards 🔽
                </div>
                :
                <div className="standards" onClick={() => { toggleStandards(false) }}>
                    Standards 🔼
                </div>
            }
            ...
            {standards ?
                <>
                    <input type="checkbox" name="m" checked={mf.m} onChange={handleCheck} />Male
                    <input type="checkbox" name="f" checked={mf.f} onChange={handleCheck} />Female
                    {mf.m ?
                        <table className="vo2max-standards">
                            <th colSpan={7}>
                                VO2 Max Norms for Male
                            </th>
                            <tr>
                                <td>Age</td>
                                <td>Very Poor</td>
